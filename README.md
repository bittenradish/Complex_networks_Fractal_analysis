...
To build an anaconda environment [environment.yml](binder/environment.yml) file could be used

### Test environment
To test if environment works run Notebook file in the root of the project

## Binder environment
If do not want to run it on local machine and just need to check out code and files, then just press binder button below
